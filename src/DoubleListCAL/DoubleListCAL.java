...
public class DoubleListCAL {
    ...
    public Object getFirstElement() {
        ...
        public Object getElementAt(int position) throws IllegalArgumentException {
             if (isEmpty()) {
                throw new NullPointerException("impossible de retourner null");
             } else {
                 if (position >= 0 && position < getNbElements()) {
                    int counter = 0;
                    DoubleNode courant = first;
    ...
    /**
         ...
         *
         * @param o non null
         * @return true si l ement a ete supprime, false pinon
         * @throws IllegalArgumentException si o est null
         */
    ...
    private int findPosition(Object o) throws IllegalArgumentException {
        int position = - 1;
        int trouve = - 1;
        if (o == null) {
    ...
    /**
     * QUESTION :
     * La fonction checkIntegrity est publique, pour pouvoir l'inclure dans les tests.
     * Ce n'est pas une bonne pratique.
     * 1/ Expliquez pourquoi la fonction ne devrait pas etre publique (5pts)
     * 
     * REPONSE :la fonction ne devrait pas etre publique car l'usager n'a pas à 
     * vérifier si les liens sont coherents dans les deux sens, la fonction
     * sera appelée au besoin par le programmeur pour s'assurer que
     * les liens sont coherents dans les deux sens pour la bonne marche de son programme
     * 
     *
     * 2/ Comment pourrions-nous utiliser cette fonction pour garantir l'integrité de nos liens,
     * sans impacter les performances en production. (5 pts)
     * indice : consultez le cours sur les tests unitaires.
     * REPONSE :
     *
     *
     *
     *
     * 3/ Conservez la visibilité publique, mais essayez d'integrer correctement la verification
     * dans votre code (5pts)
     * REPONSE (expliquer brievement comment vous avez fait):
     *
     *
     *
     *
